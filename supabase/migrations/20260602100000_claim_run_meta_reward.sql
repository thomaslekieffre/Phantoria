-- Récompenses fin de run (tickets/gemmes gacha) — sans service role Next.js
...
revoke all on function public.claim_run_meta_reward(int, text) from public;
grant execute on function public.claim_run_meta_reward(int, text) to authenticated;
